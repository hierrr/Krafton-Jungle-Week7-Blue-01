...
void serve_dynamic(int fd, char *filetname, char *cgiargs, char *method);
...
void clienterror(int fd, char *cause, char *errnum, char *shortmsg, char *longmsg)
{
    ...
    sprintf(body, "<html><tilte>Tiny Error</title>");
...
void get_filetype(char *filename, char *filetype)
{
    ...
    /* ex11.7 Extend Tiny serves MPG video files >> MP4 */
...
void serve_dynamic(int fd, char *filename, char *cgiargs, char *method)
{
    ...
    if (Fork() == 0) //line:netp:servedynamic:fork
    {
        /* Child */
