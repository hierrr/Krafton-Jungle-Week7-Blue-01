...
int main(int argc, char **argv) 
{
  ...
  listenfd = Open_listenfd(argv[1]); // open listen socket
...
void echo(int connfd) 
{
  ...
  Rio_readinitb(&rio, connfd); // connect &rio and connfd
...
void serve_static(int fd, char *filename, int filesize, char *method) 
{
  ...
  // 11.9: Modify Tiny so that when it serves static content, it copies the requested file to the connected descriptor.
